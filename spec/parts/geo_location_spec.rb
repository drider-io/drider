  ...
  describe "#address" do
    it 'should return address for location' do
      VCR.use_cassette('geocoder/location_to_address') do
        geo = GeoLocation.new(location: RGeo::Geographic.simple_mercator_factory(srid: 3857).projection_factory.point(2671865.03717625, 6418956.12797913))
